...
ggplot() +
  geom_point(data = full_data, aes(x = days, y = sqrt_totalcases), color = brewer.pal(3,"Dark2")[1], size=3,alpha=0.5) +  # Actual data points
...
ggplot() +
  geom_point(data = df_synthetic, aes(x = days, y = totalcases), color = brewer.pal(3,"Dark2")[1],size=3,alpha=0.5) +  # Actual synthetic data points
