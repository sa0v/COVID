...
The second and third diagrams reveal **Ontario** and **Quebec** as being heavily impacted by COVID-19, both in terms of total case counts and fatalities. Each province individually accounted for well over one million cases. In addition, both provinces reported a relatively high number of deaths, with Quebec having reported the most at over **20,000** fatalities. Such high numbers must be viewed in perspective, however. Ontario accounts for over [40%](https://en.wikipedia.org/wiki/Demographics_of_Ontario) of the entire Canadian population alone, while Quebec accounts for a little under [23%.](https://en.wikipedia.org/wiki/Demographics_of_Quebec) It may be that the progression of COVID-19 was in proportion for Ontario and Quebec to the rest of the country; their dominance in total case counts and deaths due to the disease may simply be a result of their populations and population densities.

The fourth diagram, illustrating the percentage of deaths due to COVID-19 versus the total case count, presents a different picture of the same data. British Columbia ranks the first in terms of the percentage of COVID-19 patients who died, but there are some encouraging results revealed by the final diagram as well. British Columbia experienced less than **2%** deaths out of an infected population of hundreds of thousands. In fact, **no** Canadian province experienced a percentage greater than  **2%.**