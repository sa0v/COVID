...
rf_model <- randomForest(sqrt_totalcases ~ days, data = train_df, ntree = 500, mtry = 1, importance = TRUE)
...
# Plot predictions vs actual values with subtitle
plot(y_test, y_pred, 
     main = "Random Forest Predictions vs Actual Values", 
     xlab = "Actual", ylab = "Predicted", 
     pch = 19, col = "blue")
abline(a = 0, b = 1, col = "red", lwd = 2)

# Add the subtitle with performance metrics
mtext(wrapped_subtitle, side = 3, line = 0, cex = 0.8, adj = 0.5)
