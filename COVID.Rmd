...
This [RStudio](https://global.rstudio.com/categories/rstudio-ide/) notebook studies a data sets published by **Health Canada** on the total number of cases and deaths due to COVID-19. It will be used in this case to study the progression of the disease in Newfoundland and Labrador.
...
# Calculate max_days
max_days <- max(variants_df$days, na.rm = TRUE)
...
## How many doses of vaccines have been distributed in the province?
