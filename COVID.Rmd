...
# Plot 1: Fitted Curve for Full Data with Performance Metrics in the Subtitle
ggplot() +
  ...
  geom_point(data = data.frame(days = future_days$days, predictions = future_predictions), aes(x = days, y = predictions), color = brewer.pal(3,"Dark2")[3], size = 3) +  # Predictions for next 365 days as blue points
  labs(
    title = str_wrap("COVID-19 in Newfoundland and Labrador Fitted and Predicted (Predictions for the Next 365 Days in Blue)",width=50),
